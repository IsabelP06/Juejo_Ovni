...
def mostrar_bienvenida_juego():
    ...
    agregar_texto(screen, "Ovnis te estan atacando es momento de ver tu habilidad en combate", 14, WIDTH // 2,
                 HEIGHT // 2)
...
while running:
    ...
    # Checar colisiones - jugador - ovni
    ...
    # Aumentar nivel
    if score % 100 == 0 and score != lastScore and score > 100:
        current_level += 1
        for i in range(current_level):
            ovni = Ovni()
            all_sprites.add(ovni)
    ...
    agregar_texto(screen, "Nivel: {}".format(current_level), 25, WIDTH // 2, 40)
